...
export const CANONICAL_TOOLS = [
  ...
  },
  {
    ...
    desc: "Generate clean placeholder text for your designs, websites, documents, and projects.",
    ...
    featured: true,
    keywords: [
      "lorem", "ipsum", "lorem ipsum", "dummy text", "placeholder", "filler text",
      "latin text", "mockup text", "greeking", "lipsum", "text generator",
      "paragraphs", "sentences", "words", "sample text", "placeholder text"
    ],
    intents: [
      "generate lorem ipsum dummy text",
      "create placeholder text for design",
      "get sample latin paragraphs",
      "fill mockup with dummy copy",
  ...
  },
  {
    id: "word",
    name: "Rootixa Writer",
    desc: "A simple online word processor for writing, editing and formatting documents.",
    category: "Document Tools",
    categoryId: "document",
    icon: FileText,
    ...
    featured: true,
    keywords: [
      "word", "writer", "word processor", "document", "docs", "text editor", "rich text",
      "google docs", "ms word", "write", "notes", "typing", "format", "doc"
    ],
    intents: [
      "write and format a document online",
      "create new text document in browser",
      "simple word processor without login",
      "draft notes and articles online"
    ],
  },
  {
    id: "cv-builder",
...
export const CATEGORIES = [
  { id: "all", name: "All Tools", count: "7 Tools", icon: LayoutGrid },
