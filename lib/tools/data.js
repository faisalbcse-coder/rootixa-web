...
export const CANONICAL_TOOLS = [
  {
    ...
    badge: "Live & Free",
    version: TOOL_VERSIONS["qr-code"] || "1.0.0.0",
    isLive: true,
    link: "/qr-code",
    users: "2.1M",
    rating: 4.9,
  ...
  },
  {
    ...
    desc: "Scan and decode QR codes and barcodes in real-time with your camera or from uploaded image files.",
    category: "QR & Barcode",
    categoryId: "qr",
    icon: Camera,
    iconColor: "text-indigo-600 dark:text-indigo-400",
    badge: "Live & Free",
    version: TOOL_VERSIONS["qr-code-scanner"] || "1.0.0.0",
    isLive: true,
    ...
    featured: true,
    keywords: [
      "qr scanner", "barcode scanner", "scan qr code", "scan barcode", "read qr code",
      "qr reader", "barcode reader", "camera scanner", "image scanner", "decode qr",
      "ean-13 scanner", "upc scanner", "code 128 scanner", "scan from photo", "wifi qr scanner"
    ],
    intents: [
      "scan a qr code with camera",
      "scan barcode from photo or image",
      "read wifi qr code credentials",
      "decode retail product barcode",
      "check qr code link safety"
    ],
  },
  {
    id: "lorem-ipsum",
    ...
    badge: "Live & Free",
    version: TOOL_VERSIONS["lorem-ipsum"] || "1.0.0.0",
    isLive: true,
    link: "/lorem-ipsum",
    users: "1.8M",
    rating: 4.9,
...
export const CATEGORIES = [
  { id: "all", name: "All Tools", count: "9 Tools", icon: LayoutGrid },
