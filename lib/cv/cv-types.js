...
export const SECTION_METADATA = {
  ...
  awards: {
    ...
    title: "Awards & Honors",
    shortTitle: "Awards",
    description: "Academic honors, competition prizes, and professional recognitions.",
  },
  publications: {
    id: "publications",
    title: "Publications & Research",
    shortTitle: "Publications",
    description: "Academic papers, journal articles, conference proceedings, and books.",
  },
  volunteer: {
    id: "volunteer",
    title: "Volunteering & Leadership",
    shortTitle: "Volunteering",
    description: "Community initiatives, NGO work, and non-profit involvement.",
  },
  references: {
    id: "references",
    title: "References",
    shortTitle: "References",
    description: "Professional referees or availability on request.",
  },
  customSections: {
    id: "customSections",
    title: "Additional Section",
    shortTitle: "Custom",
    description: "Custom user-defined sections such as Interests, Patents, or Workshops.",
  },
};
...
export function createEmptyAward() {
  return {
    id: generateId("award"),
    name: "",
    issuer: "",
