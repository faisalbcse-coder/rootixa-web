...
export function HomeView() {
  ...
  const navLinkClass =
    "relative px-3.5 py-2 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-full transition-colors duration-200 flex items-center gap-1.5 cursor-pointer";
    ...
    >
      ...
      >
        <nav
          ...
          className={`max-w-7xl mx-auto transition-all duration-300 flex justify-between items-center ${
            isScrolled
              ? "bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-lg shadow-slate-200/50 dark:shadow-slate-950/50 border border-slate-200/60 dark:border-slate-800/80 rounded-full px-6 py-3"
        ...
        >
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <a href="#popular-tools" className={navLinkClass}>
              <Wrench className="w-4 h-4" /> Popular Tools
            </a>
            <a href="#why-rootixa" className={navLinkClass}>
              <ShieldCheck className="w-4 h-4" /> Why Rootixa
            </a>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a
              href="#popular-tools"
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-full text-xs font-bold transition-all duration-300 shadow-md shadow-indigo-600/20 hover:shadow-indigo-600/40 hover:-translate-y-0.5"
            >
              Explore Tools
            </a>
          </div>
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden p-2 text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-full transition-colors cursor-pointer"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-4 right-4 mt-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xl rounded-3xl p-5 flex flex-col space-y-2.5 z-50 animate-in fade-in slide-in-from-top-3 duration-200">
            <Link
              href="/"
              onClick={() => setMobileMenuOpen(false)}
              className="text-slate-800 dark:text-slate-200 font-bold hover:text-indigo-600 px-4 py-2.5 rounded-xl flex items-center gap-3 transition-colors"
            >
            ...
            <a
              ...
              className="text-slate-800 dark:text-slate-200 font-bold hover:text-indigo-600 px-4 py-2.5 rounded-xl flex items-center gap-3 transition-colors"
            >
              <LayoutGrid className="w-4 h-4 text-indigo-500" /> Categories
            </a>
            <a
              href="#popular-tools"
              onClick={() => setMobileMenuOpen(false)}
            ...
            <div
              className="flex items-center justify-between px-4 py-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors"
              onClick={toggleDarkMode}
            >
      ...
      <main id="main-content" className="flex-grow">
        ...
        <section
          ...
          className="py-14 px-4 bg-slate-50/70 dark:bg-slate-900/40 border-y border-slate-200/60 dark:border-slate-800/60"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-10">
              ...
              <p className="mt-2 text-sm sm:text-base text-slate-600 dark:text-slate-400">
                Find the right tool faster with Rootixa&apos;s collection of simple online utilities.
              </p>
            </div>
              ...
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <button
                    key={cat.id}
                    onClick={() => handleCategorySelect(cat.id)}
                    className={`p-4 sm:p-5 rounded-2xl border text-left transition-all duration-200 flex items-start gap-3.5 group cursor-pointer ${
                      isSelected
                        ? "bg-indigo-50 dark:bg-indigo-950/30 border-indigo-500 dark:border-indigo-400 ring-2 ring-indigo-500/20 shadow-md"
                        : "bg-white dark:bg-slate-800/90 border-slate-200/80 dark:border-slate-700/80 hover:border-indigo-300 dark:hover:border-indigo-500/50 hover:shadow-md"
                    }`}
                  >
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                        isSelected
                          ...
                          : "bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 group-hover:bg-indigo-50 group-hover:text-indigo-600"
                      }`}
                    >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <h2
                ...
                className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tight"
              >
                What Can You Do with Rootixa?
              </h2>
              <p className="mt-2 text-sm sm:text-base text-slate-600 dark:text-slate-400">
                Explore tools designed around your real-world tasks and daily workflows.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                <div className="w-10 h-10 rounded-xl bg-violet-50 dark:bg-violet-950/40 text-violet-600 dark:text-violet-400 flex items-center justify-center mb-4">
                ...
                >
                  View PDF tools <ArrowRight className="w-3 h-3" />
                </button>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                ...
                <button
                  ...
                  className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1 cursor-pointer"
                >
                  View image tools <ArrowRight className="w-3 h-3" />
                </button>
              </div>

              {/* Purpose 3: QR Codes */}
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                  Generate QR codes for websites, text and other information.
                </p>
                <Link
                  href="/qr-code"
                  className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1"
                >
                  Open QR Generator <ArrowRight className="w-3 h-3" />
                </Link>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                  Create useful documents for work, study and everyday needs.
                </p>
                <button
                  onClick={() => handleCategorySelect("document")}
                  className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1 cursor-pointer"
                >
                  View document tools <ArrowRight className="w-3 h-3" />
                </button>
              </div>

              {/* Purpose 5: AI Tools */}
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                <div className="w-10 h-10 rounded-xl bg-fuchsia-50 dark:bg-fuchsia-950/40 text-fuchsia-600 dark:text-fuchsia-400 flex items-center justify-center mb-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                  Simplify writing, text processing and other everyday tasks.
                </p>
                <button
                  onClick={() => handleCategorySelect("ai")}
                  className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1 cursor-pointer"
                >
                  View AI utilities <ArrowRight className="w-3 h-3" />
                </button>
              </div>

              {/* Purpose 6: Everyday Utilities */}
              <div className="bg-white dark:bg-slate-800/90 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                  Generate invoices, calculate costs, and organize digital assets.
                </p>
                <button
                  onClick={() => handleCategorySelect("business")}
                  className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1 cursor-pointer"
                >
                  View business tools <ArrowRight className="w-3 h-3" />
                </button>
              </div>
            </div>
          </div>
