...
import { copyToClipboard } from "@/lib/barcode/export";
...
export function CodeScanner() {
  ...
  const handleCopyResult = async () => {
    ...
    try {
      ...
      console.error("Failed to copy scan result:", err);
    }
  };
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-xs font-semibold rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 transition flex items-center gap-1.5 cursor-pointer shadow-2xs"
